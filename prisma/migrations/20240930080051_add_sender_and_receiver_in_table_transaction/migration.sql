...
CREATE TABLE "new_Transaction" (
    ...
    CONSTRAINT "Transaction_creceiverId_fkey" FOREIGN KEY ("creceiverId") REFERENCES "Customer" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Transaction" ("amount", "created_at", "id", "merchantId", "pointId", "receiverAddress", "senderAddress", "transactionTypeId", "txHash", "updated_at") SELECT "amount", "created_at", "id", "merchantId", "pointId", "receiverAddress", "senderAddress", "transactionTypeId", "txHash", "updated_at" FROM "Transaction";
