...
export const MERCHANT_NOT_FOUND = '404002: Merchant not found';
export const POINT_NOT_FOUND = '404003: Point not found';
export const SESSION_NOT_FOUND = '404004: Session not found';
export const API_KEY_NOT_FOUND = '404005: API key not found';
export const CUSTOMER_NOT_FOUND = '404006: Customer not found';
