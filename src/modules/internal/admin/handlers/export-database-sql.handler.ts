...
export class ExportDatabaseSql {
  ...
  private readonly tables: TableConfig[] = [
    ...
    {
      tableName: 'DirectTransferOperation',
      prismaKey: 'directTransferOperation',
      columns: [
        { property: 'id' },
        { property: 'merchantId' },
        { property: 'customerId' },
        { property: 'voucherId' },
        { property: 'quantity' },
        { property: 'reservedVoucherCodeIds', arrayType: 'text' },
        { property: 'sourcePool' },
        { property: 'status' },
        { property: 'txHash' },
        { property: 'errorNote' },
    ...
    {
      tableName: 'DirectTransferRecoveryRun',
      prismaKey: 'directTransferRecoveryRun',
      columns: [
        { property: 'id' },
        { property: 'status' },
        { property: 'actorId' },
        ...
        { property: 'startedAt' },
        { property: 'finishedAt' },
        { property: 'inspectedCount' },
        { property: 'confirmedCount' },
        { property: 'releasedCount' },
    ...
    {
      tableName: 'DirectTransferOperationEvent',
      prismaKey: 'directTransferOperationEvent',
      columns: [
        { property: 'id' },
        { property: 'recoveryRunId' },
    ...
    },
    {
      ...
      columns: [
        ...
        { property: 'directTransferOperationId' },
      ],
    },
    {
