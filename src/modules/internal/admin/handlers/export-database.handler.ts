...
export class ExportDatabase {
  ...
  async execute(): Promise<{
    ...
    const [
      ...
      vouchers,
      listingBatches,
      directTransferOperations,
      directTransferRecoveryRuns,
      directTransferOperationEvents,
      voucherCodes,
      treasuries,
      tempLinkCreateUsers,
      aisTransferLogs,
      ...
      this.prisma.directTransferOperation.findMany({
        orderBy: { id: 'asc' },
      }),
      this.prisma.directTransferRecoveryRun.findMany({
        orderBy: { id: 'asc' },
      }),
      this.prisma.directTransferOperationEvent.findMany({
        orderBy: { id: 'asc' },
      }),
    ...
    const payload = {
      ...
      counts: {
        ...
        directTransferOperations: directTransferOperations.length,
        directTransferRecoveryRuns: directTransferRecoveryRuns.length,
        directTransferOperationEvents: directTransferOperationEvents.length,
